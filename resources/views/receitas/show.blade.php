            ...
            <div id="printTable" class="bg-white rounded-3 shadow-sm p-4">
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4 receita-description">
                            <p class="lead" style="white-space: pre-wrap;">{{ $receita->receita_descricao }}</p>
                        </div>
                ...
                <div class="mt-5">
                        ...
                        @if ($receita->dicas)
                            <li class="nav-item" role="presentation">
                                <button class="nav-link fw-bold" id="dicas-tab" data-bs-toggle="tab"
                                    data-bs-target="#dicas-tab-pane" type="button" role="tab"
                                    aria-controls="dicas-tab-pane" aria-selected="false">
                    ...
                    <div class="tab-content p-4 border border-top-0 rounded-bottom" id="receitaTabsContent">
                        ...
                        <!-- Dicas -->
                        @if ($receita->dicas)
                            <div class="tab-pane fade" id="dicas-tab-pane" role="tabpanel"
                                aria-labelledby="dicas-tab" tabindex="0">
                                <div class="row">
                                    <div class="col-md-10 mx-auto">
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm hover-shadow transition-all">
                                    <div class="position-relative">
                                        <img src="{{ asset('storage/' . $related->receita_foto) }}"
                                            class="card-img-top" alt="{{ $related->receita_titulo }}"
                                                ...
                                                <div>
                                                    <form
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            data-bs-title="Excluir avaliação">
                                ...
                                <div class="card border bg-light">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('receitas.rate', $receita->id) }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label for="comment" class="form-label fw-bold">Comentário sobre a
                                                    receita
                                                    (opcional)</label>
                        ...
                        @else
                            <div class="alert alert-info mt-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="mb-0">
                                        <a href="{{ route('login') }}" class="alert-link">Faça login</a> para avaliar
                                        esta
                                        receita.
                                    </p>
                                </div>
