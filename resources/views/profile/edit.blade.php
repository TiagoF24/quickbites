                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="pb-6 mb-6 border-b border-gray-200">
                        <div class="flex items-center space-x-4">
                            <!-- Avatar - -->
                            <div
                                class="flex items-center justify-center w-16 h-16 text-xl text-white bg-orange-500 rounded-full overflow-hidden">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600"><i class="bi bi-bookmark-fill"></i> Membro desde
                                    {{ Auth::user()->created_at->format('d/m/Y') }}</p>
                                <p class="text-sm text-gray-800">{{ Auth::user()->receitas->count() }} receitas
                                    publicadas</p>
                            </div>
                        </div>
                    </div>
